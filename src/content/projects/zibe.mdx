---
title: "ZIBE"
summary: "App de mensajería Android (Real-time) Publicada inicialmente en 2021 tras un año de desarrollo. Desde octubre de 2025, el proyecto atraviesa una fase de modernización integral y refactorización para consolidarse como pieza central de mi portfolio técnico. Hoy es el proyecto donde más visible se vuelve mi forma de trabajar en Android: Kotlin, Jetpack Compose, Material 3, MVVM, Hilt, repositorios, DataStore y Firebase, con foco en arquitectura mantenible y evolución incremental sobre una base ya existente."
language: "es"
published: true
featured: true
